...
async function checkFeatures(context, config, args) {
  ...
  const identity = (_g = (_f2 = context.__smithy_context) == null ? void 0 : _f2.selectedHttpAuthScheme) == null ? void 0 : _g.identity;
...
function __generator(thisArg, body) {
  var _ = { label: 0, sent: function() {
    ...
    return t2[1];
  }, trys: [], ops: [] }, f3, y, t2, g2 = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
...
var createDefaultUserAgentProvider = ({ serviceId, clientVersion }) => async (config) => {
  ...
  const appId = await ((_f2 = config == null ? void 0 : config.userAgentAppId) == null ? void 0 : _f2.call(config));
  if (appId) {
...
var se_GetFunctionRecursionConfigCommand = async (input, context) => {
  const b2 = requestBuilder(input, context);
  const headers = {};
...
var se_PutFunctionRecursionConfigCommand = async (input, context) => {
  const b2 = requestBuilder(input, context);
  const headers = {
    "content-type": "application/json"
  };
...
var de_GetFunctionRecursionConfigCommand = async (output, context) => {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const contents = map({
...
var de_PutFunctionRecursionConfigCommand = async (output, context) => {
  if (output.statusCode !== 200 && output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const contents = map({
